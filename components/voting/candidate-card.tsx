		...
		>
			<GlassCard
				...
				className={cn(
					...
					selected
						? "border-2 border-[#10b981] shadow-[0_0_20px_rgba(16,185,129,0.3)]"
			...
			>
				...
				<div className="relative mb-4">
					{image && !image.includes("placeholder.svg") ? (
						...
						<div className="w-full aspect-square bg-[#1c1c1c] border border-[#404040] rounded-lg flex items-center justify-center">
							<User className="w-20 h-20 text-[#404040]" />
						</div>
					)}
					{selected && (
						<motion.div
