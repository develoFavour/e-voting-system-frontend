...
export function Navbar() {
    ...
    return (
        <motion.nav
            initial={{ y: -100 }}
            animate={{ y: 0 }}
            className="fixed top-0 left-0 right-0 z-50 glass-strong border-b border-gray-200 dark:border-[#404040] bg-white/80 dark:bg-[#1c1c1c]/80"
        >
            <div className="container mx-auto px-4">
                <div className="flex items-center justify-between h-20 pt-2">
                    ...
                    <div className="hidden md:flex items-center gap-6">
                        <Link href="/" className="text-[#a3a3a3] dark:text-[#a3a3a3] hover:text-gray-900 dark:hover:text-white transition-colors">
                            Home
                        </Link>
                        <Link href="/results" className="text-[#a3a3a3] dark:text-[#a3a3a3] hover:text-gray-900 dark:hover:text-white transition-colors">
                            Results
                        </Link>
                        <ThemeToggle />
                        <Link href="/login">
